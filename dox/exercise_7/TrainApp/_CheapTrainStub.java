...
public class _CheapTrainStub extends org.omg.CORBA.portable.ObjectImpl implements TrainApp.CheapTrain
{
  ...
  public String[] errors ()
  {
            ...
            try {
                ...
                $in = _invoke ($out);
                String $result[] = TrainApp.TrainErrorsHelper.read ($in);
                return $result;
  ...
  public void errors (String[] newErrors)
  {
            ...
            try {
                ...
                TrainApp.TrainErrorsHelper.write ($out, newErrors);
                $in = _invoke ($out);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
  ...
  public void addError (String error, org.omg.CORBA.ShortHolder errors) throws TrainApp.SevereMalfunctionException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                if (_id.equals ("IDL:TrainApp/SevereMalfunctionException:1.0"))
                    throw TrainApp.SevereMalfunctionExceptionHelper.read ($in);
                else
                    throw new org.omg.CORBA.MARSHAL (_id);
            } catch (org.omg.CORBA.portable.RemarshalException $rm) {
