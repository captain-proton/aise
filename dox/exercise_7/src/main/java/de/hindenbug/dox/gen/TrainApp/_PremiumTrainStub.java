...
public class _PremiumTrainStub extends org.omg.CORBA.portable.ObjectImpl implements PremiumTrain
{
  ...
  public void setTemperature (org.omg.CORBA.FloatHolder temperature) throws AirconditionerException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                if (_id.equals ("IDL:TrainApp/AirconditionerException:1.0"))
                    throw AirconditionerExceptionHelper.read ($in);
                else
                    throw new org.omg.CORBA.MARSHAL (_id);
            } catch (org.omg.CORBA.portable.RemarshalException $rm) {
  ...
  public void setDiffuseLightBrightness (org.omg.CORBA.FloatHolder brightness)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("setDiffuseLightBrightness", true);
                $in = _invoke ($out);
                brightness.value = $in.read_float ();
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                ...
                setDiffuseLightBrightness (brightness        );
            } finally {
                _releaseReply ($in);
            }
  } // setDiffuseLightBrightness

  public void setChilloutMusic (float audioData)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("setChilloutMusic", true);
                $out.write_float (audioData);
                $in = _invoke ($out);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
