...
public class GUIDefaults
{
    ...
    public static final Font active = new Font("monospaced", Font.PLAIN, 14);
    public static final Font menuFont = new Font("monospaced",Font.PLAIN,12);
    public static final Font status = new Font("serif", Font.BOLD, 12);
