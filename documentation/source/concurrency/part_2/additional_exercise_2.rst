...
.. literalinclude:: ../../_static/src/concurrency/src/main/java/ude/masteraise/concurrency/part2/extrasheet2/Exercise2_1.java
   :language: Java
...
Implementierung (``Exercise2_2.java``)
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

.. literalinclude:: ../../_static/src/concurrency/src/main/java/ude/masteraise/concurrency/part2/extrasheet2/Exercise2_2.java
   :language: Java
...
.. literalinclude:: ../../_static/src/concurrency/src/main/java/ude/masteraise/concurrency/part2/extrasheet2/Exercise2_3.java
   :language: Java
